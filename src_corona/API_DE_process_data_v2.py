...
DATA_FILE_NAME = 'corona_data.pkl'
# TEST_DATA_FILE_NAME = 'corona_data_test.pkl'  # contains only 500 samples

VOCA_FILE_NAME = 'corona_dic.pkl'
GLOVE_FILE_NAME = 'corona_glove.pkl'
...
class ProcessData:
    ...
    def load_data(self):
        ...
        if self.is_test:
            ...
            self.test_data = pickle.load(open(DATA_DIR + TEST_DATA_FILE_NAME, 'r'))
        else:
            self.test_data = pickle.load(open(DATA_DIR + DATA_FILE_NAME, 'r'))
